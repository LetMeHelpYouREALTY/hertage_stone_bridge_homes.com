          ...
          <a href="/" title="Heritage at Stonebridge">
            <div className="flex items-center space-x-2">
              ...
              <div className="text-left">
                <div className="text-lg font-bold text-gray-900">Heritage at Stonebridge</div>
              </div>
            </div>
          </a>
        </div>
        ...
        <nav className="flex items-center space-x-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transition-all transform hover:scale-105 shadow-lg"
            >
              Schedule Tour
            </a>
          </div>
